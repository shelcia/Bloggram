                    ...
                    <div className="card-body">
                        ...
                        <div className="row">
                          <div className="col-sm-4" id="icon-container">
                            <img src={Like} alt="" onClick={() => addLikes(post.id, post.likes)}/>
                            <p>{post.likes}</p>
                          </div>
                          <div className="col-sm-4" id="icon-container">
                            <img src={Dislike} alt="" onClick={() => disLikes(post.id, post.dislikes)}/>
                             <p>{post.dislikes}</p>
                          </div>
                          <div className="col-sm-4" id="icon-container">
                            <img src={Heart} alt="" onClick={() => hearts(post.id, post.hearts)} />
                              <p>{post.hearts}</p>
                          </div>
                        </div>
                    </div>
