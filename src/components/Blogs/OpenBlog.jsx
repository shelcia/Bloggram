          ...
          <div className="row">
            <div className="col-sm-4" id="icon-container">
              <img
                src={Like}
                alt=""
                onClick={() => errorNotify("You need to login to like")}
              />
            ...
            <div
              className="col-sm-4"
              id="icon-container"
              onClick={() => errorNotify("You need to login to dislike")}
            >
              <img src={Dislike} alt="" />
            ...
            <div
              className="col-sm-4"
              id="icon-container"
              onClick={() => errorNotify("You need to login to addheart")}
            >
              <img src={Heart} alt="" />
