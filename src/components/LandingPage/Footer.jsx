            ...
            <div className="container-fluid pt-3" id="footer">
                <div className="row pb-5">
                    <div className="col-sm-6">
                        ...
                        <div className="d-flex" style={{flexDirection:"column"}}>
                            ...
                            <Link to={`/category/${category.link}`} key={category.id} className="mb-0">{category.name}</Link>
                            ))}
                        </div>
                    ...
                    <div className="col-sm-6">
                        <h4>Social Handles</h4>
                         <div className="d-flex" style={{flexDirection:"column"}}>
                            ...
                            <a href={`${category.link}`} key={category.id} className="mb-0">{category.name} </a>
                            ))}
                        </div>
                    </div>
                </div>
                <div className="container">
                    <div className="text-center" id="footerTag">
                        <p>Developed by Shelcia. All rights reserved.</p>
                    </div>
                </div>
            </div> 
